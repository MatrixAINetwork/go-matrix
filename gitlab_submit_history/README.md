...
Merge branch 'master' into master_nodeId	(Author: sunanxiang)
delete signcmd	(Author: sunanxiang)
upTime初选节点由折半修改为一直累加	(Author: sunanxiang)
fmt	(Author: sunanxiang)
回滚账户，keystore优化，dumpblock,getTransactionRecepit显示man地址	(Author: sunanxiang)
因fetch等处理量太大导致无法同步等问题	(Author: sunanxiang)
Update version.go	(Author: sunanxiang)
fmt	(Author: sunanxiang)
Merge branch 'master' into master_nodeId	(Author: sunanxiang)
delete old address	(Author: sunanxiang)